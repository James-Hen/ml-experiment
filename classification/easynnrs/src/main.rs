...
fn main() {
    ...
    for e in 0..30 {
        ...
        let train_loss = nn.train_once(&train_ims, &train_lbs, 1024, 0.01, false);
        ...
        println!("Average training loss: {}", train_loss);
    ...
    let mut file = File::create("./result_fp64/rust_results.json").unwrap();
